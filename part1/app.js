...
app.get('/api/walkers/summary', async (req, res) => {
    try {
        const [rows] = await db.execute(`SELECT u.username AS walker_username, COUNT(w.rating_id) AS total_ratings,
            ...
            FROM Users u LEFT JOIN WalkRatings w ON w.walker_id = u.user_id
            WHERE u.role='walker'
            GROUP BY u.user_id
            `);
